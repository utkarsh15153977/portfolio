      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-wrap items-center justify-between gap-4 px-5 py-8 sm:px-8">
        ...
        <div>
          ...
          <p className="mt-1 font-mono text-[9px] tracking-[0.22em] text-ink-faint">
            © {currentYear} {profile.name.toUpperCase()} — JAVA BACKEND
            DEVELOPER
          </p>
        </div>
        ...
        <div className="flex items-center gap-6">
          <p className="hidden font-mono text-[9px] leading-relaxed tracking-[0.2em] text-ink-faint sm:block">
            SPRING BOOT · KAFKA · POSTGRESQL · AWS
            <br />
          ...
          <button
            ...
            className="inline-flex size-10 items-center justify-center border border-line text-ink-dim transition-colors hover:border-accent/50 hover:text-accent focus-visible:border-accent"
          >
  ...
  return (
    <SystemProvider>
      ...
      {/* -----------------------------------------------------------------
          ...
          Desktop reserves space for the fixed sidebar.
          ----------------------------------------------------------------- */}
