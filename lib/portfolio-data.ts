...
// - Phase 2 AI/RAG should consume this module.
// - Production experience and AI exploration must remain clearly separated.
// - Keep measurable claims grounded in verified experience.
// ============================================================================
...
export type ExperienceStatus = "production" | "exploring";
...
export type SkillTone = "production" | "exploring";
...
export const githubProfileUrl =
  "https://github.com/utkarsh15153977";
...
export interface SystemStatus {
  name: string;
  status: "ONLINE" | "EXPLORING" | "EXPERIMENT";
}
...
export const bootSequence = {
  ...
  ] satisfies readonly SystemStatus[],
...
// Storytelling device, NOT a chronology.
// ---------------------------------------------------------------------------
...
export const techProgression: readonly TechProgressionNode[] = [
  {
    key: "spring-boot",
    label: "SPRING BOOT",
    detail:
...
export const chatProject: ChatProject = {
  id: "realtime-chat",
  index: "P-01",
  ...
  githubUrl:
    "https://github.com/utkarsh15153977/real-time-chat-application",
...
// ---------------------------------------------------------------------------
// GITHUB REPOSITORIES
// Verified metadata only. Do not add fabricated metrics.
// ---------------------------------------------------------------------------
...
export const githubRepos: readonly GithubRepo[] = [
  featuredRepo,
...
// Interactive diagrams used by the portfolio.
// ---------------------------------------------------------------------------
...
export interface DiagNode {
  ...
  // Structured inspector fields.
  // Components can fall back to `desc` when these fields are absent.
  role?: string;
  why?: string;
  tech?: string;
...
const CHAT_NODES: readonly DiagNode[] = [
  {
    id: "users",
    label: "USERS",
    desc: "Web and mobile clients holding persistent WebSocket sessions.",
    role: "Message entry point",
    why:
      "Conversations start here — clients hold open WebSocket sessions instead of polling for updates.",
...

  {
    id: "ws",
    label: "WEBSOCKET",
    sub: "persistent channel",
    desc:
      "Push-based real-time transport between clients and the Chat Service — no polling.",
    role: "Real-time transport",
    why:
      "A persistent channel carries messages in both directions the moment they are sent, instead of relying on request/response polling.",
    tech: "WebSockets",
    kind: "compute",
    layer: 1,
    col: 1,
...

  {
    ...
    sub: "spring boot",
    desc:
      "Owns connection lifecycle, routing, fan-out and validation. Acknowledges ingestion before downstream work completes.",
    role: "Ingress & routing",
    why:
      "Acknowledges ingestion quickly, owns session routing and fan-out, and keeps transport concerns out of business logic.",
    tech: "Spring Boot",
    kind: "compute",
    layer: 2,
    col: 1,
...

  {
    ...
    sub: "event bus",
    desc:
      "Event-driven messaging layer for asynchronous communication — absorbs bursts and decouples delivery from processing.",
    role: "Asynchronous event processing",
    why:
      "Decouples messaging workflows and supports event-driven communication.",
    tech: "Apache Kafka",
    kind: "messaging",
    layer: 3,
    col: 0,
...

  {
    ...
    sub: "async consumers",
    desc:
      "Consumes Kafka events, applies failure handling and retry mechanisms, then routes results to stores.",
    role: "Async consumer pipeline",
    why:
      "Processes events independently of ingestion, so slow or restarting consumers never block live delivery.",
...

  {
    ...
    sub: "persistence",
    desc:
      "Source of truth — every message persisted as queryable conversation history.",
    role: "Source of truth",
    why:
      "Every message becomes durable, queryable history — persisted through the event pipeline so database slowdowns never block delivery.",
    tech: "PostgreSQL",
    kind: "data",
    layer: 5,
    col: 0,
...

  {
    ...
    sub: "caching layer",
    desc:
      "Caching layer used to reduce database load and improve read performance for recent conversations.",
    role: "Caching layer",
    why:
      "Serves hot reads before they reach PostgreSQL — reducing database load and improving message fetch latency.",
    tech: "Redis",
    kind: "data",
    layer: 5,
    col: 1,
...

  {
    ...
    sub: "media storage",
    desc:
      "Durable storage for shared images and attachments, kept off the service instances.",
    role: "Media storage",
    why:
      "Images and attachments live in durable object storage rather than on service instances.",
    tech: "Amazon S3",
    kind: "data",
    layer: 6,
    col: 0,
...

  {
    id: "cw",
    label: "CLOUDWATCH",
    sub: "monitoring · logging",
    desc:
      "Centralized logging and monitoring across all containers in the cluster.",
    role: "Monitoring & logging",
    why:
      "Centralized logs across containers make debugging faster and reduce incident resolution time.",
...

  {
    ...
    desc:
      "Every service runs as a Docker container on Kubernetes — horizontal scaling with rolling zero-downtime deployments.",
    role: "Deployment layer",
    why:
      "Horizontal scaling with rolling zero-downtime deployments — and failed instances are rescheduled automatically.",
    tech: "Docker · Kubernetes",
    kind: "platform",
    layer: 7,
    col: 0,
...
const CHAT_EDGES: readonly DiagEdge[] = [
  { from: "users", to: "ws" },
  { from: "ws", to: "chat" },
  { from: "chat", to: "kafka" },
  { from: "kafka", to: "proc" },
...
export const architectureDiagrams: readonly ArchitectureDiagram[] = [
  {
    key: "microservices",
    tab: "MICROSERVICES",
    ...
    nodes: [
      {
        id: "client",
        label: "CLIENTS",
        desc: "Web / mobile / partner consumers calling public APIs.",
        kind: "client",
        layer: 0,
        col: 1,
      },

      {
        ...
        label: "API GATEWAY",
        desc:
          "Single entry point — routing, auth boundary and traffic policy in front of all services.",
        kind: "compute",
        layer: 1,
        col: 1,
      },

      {
        ...
        sub: "spring boot",
        desc:
          "Account management domain — ownership, profiles and state via REST APIs.",
        kind: "compute",
        layer: 2,
        col: 0,
      },
      ...
      {
        id: "txn",
        label: "TRANSACTION SVC",
        sub: "spring boot",
        desc:
          "Transaction processing domain — high-volume writes with strict correctness.",
        kind: "compute",
        layer: 2,
        col: 1,
      },

      {
        ...
        sub: "spring boot",
        desc:
          "Real-time messaging domain over WebSockets.",
        kind: "compute",
        layer: 2,
        col: 2,
      },

      {
        ...
        sub: "discovery",
        desc:
          "Service discovery and inter-service communication — services locate each other without hard-coded hosts.",
        kind: "messaging",
        layer: 3,
        col: 0,
      },

      {
        ...
        sub: "fault tolerance",
        desc:
          "Circuit breaker and retry patterns for improved fault tolerance under partial failure.",
        kind: "messaging",
        layer: 3,
        col: 1,
      },

      {
        ...
        label: "POSTGRESQL",
        desc:
          "Optimized queries and indexing per service — 30% latency reduction in production workloads.",
        kind: "data",
        layer: 3,
        col: 2,
      },

      {
        ...
        label: "REDIS",
        desc:
          "Caching layer used to reduce database load and improve read performance.",
        kind: "data",
        layer: 3,
        col: 3,
      },

      {
        id: "k8s",
        label: "KUBERNETES",
        sub: "docker · jenkins ci/cd",
        desc:
          "Containerized services with zero-downtime rolling deployments, automated via Jenkins pipelines.",
        kind: "platform",
        layer: 4,
        col: 1,
        colSpan: 2,
    ...
    nodes: [
      {
        ...
        sub: "producers",
        desc:
          "Domain services emit state-change events (transactions, account updates) instead of calling each other synchronously.",
        kind: "compute",
        layer: 0,
        col: 1,
      },

      {
        id: "kafka",
        label: "KAFKA",
        sub: "topics · partitions",
        desc:
          "Event-driven messaging layer for asynchronous communication — ordered, durable, replayable.",
        kind: "messaging",
        layer: 1,
        col: 1,
      },

      {
        ...
        sub: "resilience4j",
        desc:
          "Failed events are retried instead of dropped — circuit breakers stop cascading failure during outages.",
        kind: "messaging",
        layer: 2,
        col: 1,
      },

      {
        ...
        sub: "async workers",
        desc:
          "Consumers process events independently — scaling and deploying without touching producers.",
        kind: "compute",
        layer: 2,
        col: 0,
      },

      {
        ...
        label: "POSTGRESQL",
        desc:
          "Processed state persisted as queryable records.",
        kind: "data",
        layer: 3,
        col: 0,
      },

      {
        ...
        label: "REDIS",
        desc:
          "Cache invalidated / warmed as events flow through.",
        kind: "data",
        layer: 3,
        col: 1,
      },
      ...
      {
        id: "aws",
        label: "AWS DATA STACK",
        sub: "s3 · glue · athena",
        desc:
          "Events landed to S3 and catalogued with Glue, enabling efficient querying of large datasets with Athena.",
        kind: "data",
        layer: 3,
        col: 2,
      },
...

  {
    ...
    blurb:
      "The flagship project's architecture — WebSocket ingress, Kafka backbone, dual sinks, containerized deployment.",
    layers: [
      "CLIENTS",
      "TRANSPORT",
      "SERVICE",
    ...
    nodes: [
      {
        id: "client",
        label: "CLIENT",
        desc: "Callers hitting public REST endpoints.",
        kind: "client",
        layer: 0,
        col: 1,
      },

      {
        ...
        label: "LOAD BALANCER",
        desc:
          "Distributes traffic across stateless API instances.",
        kind: "platform",
        layer: 1,
        col: 1,
      },

      {
        ...
        sub: "spring boot mvc",
        desc:
          "Stateless Spring MVC controllers — validated, versioned contract endpoints.",
        kind: "compute",
        layer: 2,
        col: 1,
      },

      {
        ...
        sub: "jwt authn",
        desc:
          "Token-based authentication and route-level authorization at the edge of the API.",
        kind: "messaging",
        layer: 3,
        col: 0,
      },

      {
        ...
        sub: "resilience4j",
        desc:
          "Circuit breaker and retry patterns — dependencies fail fast instead of cascading.",
        kind: "messaging",
        layer: 3,
        col: 1,
      },

      {
        ...
        label: "CLOUDWATCH",
        desc:
          "Centralized logs and metrics cut incident resolution time.",
        kind: "platform",
        layer: 3,
        col: 2,
      },

      {
        ...
        label: "REDIS",
        desc:
          "Hot responses served from cache before touching the database.",
        kind: "data",
        layer: 4,
        col: 0,
      },

      {
        ...
        label: "POSTGRESQL",
        desc:
          "Indexed, query-optimized persistence — the 30% latency reduction lives here.",
        kind: "data",
        layer: 4,
        col: 1,
      },

      {
        ...
        sub: "s3 · glue · athena",
        desc:
          "Large-dataset storage and analysis offloaded to the AWS data stack.",
        kind: "data",
        layer: 4,
        col: 2,
      },
  ...
  // -------------------------------------------------------------------------
  // AI ARCHITECTURE
  // Exploration only — NOT production experience.
  // -------------------------------------------------------------------------
    ...
    nodes: [
      {
        ...
        label: "USER",
        desc:
          "Intent in natural language instead of hard-coded API calls.",
        kind: "client",
        layer: 0,
        col: 1,
        exploring: true,
...

      {
        ...
        sub: "llm core",
        desc:
          "Currently exploring LLM-driven agents — reasoning over goals and deciding next actions.",
        kind: "ai",
        layer: 1,
        col: 1,
        exploring: true,
...

      {
        ...
        label: "ORCHESTRATOR",
        desc:
          "Exploration concept — planning loop that routes between retrieval, tools and memory.",
        kind: "ai",
        layer: 2,
        col: 1,
        exploring: true,
...

      {
        ...
        label: "RAG",
        desc:
          "Experiment track: grounding model answers in retrieved knowledge.",
        kind: "ai",
        layer: 3,
        col: 0,
        exploring: true,
...

      {
        ...
        label: "TOOLS",
        desc:
          "Exploration concept: typed function tools the agent can invoke.",
        kind: "ai",
        layer: 3,
        col: 1,
        exploring: true,
...

      {
        ...
        label: "MEMORY",
        desc:
          "Exploration concept: short- and long-term agent memory.",
        kind: "ai",
        layer: 3,
        col: 2,
        exploring: true,
      ...
      {
        id: "be",
        label: "JAVA BACKEND FOUNDATION",
        sub: "microservices · kafka · aws",
        desc:
          "Everything above would run on the same principles I use in production: services, events, resilience and observability.",
        kind: "compute",
        layer: 4,
        col: 1,
        colSpan: 3,
...
// ---------------------------------------------------------------------------
// BEYOND CODE
// Editable placeholders — nothing fabricated.
// ---------------------------------------------------------------------------
...
export const interests: readonly InterestCard[] = [
  {
    key: "learning",
    icon: "graduation",
    title: "LEARNING",
    lines: [
      "Currently exploring LLMs, RAG and agentic systems.",
    ],
    placeholder: false,
  },
...
// ---------------------------------------------------------------------------
// PHASE 2 — AI / RAG HOOK POINTS
//
// Future AI tool surface:
//
//   searchProjects()
//   searchExperience()
//   getSkills()
...
//   Tools
//
// This file remains the source of truth for portfolio knowledge.
// ---------------------------------------------------------------------------

// ---------------------------------------------------------------------------
// PORTFOLIO KNOWLEDGE BASE
//
// Convenience aggregate for future AI/RAG consumption.
//
// UI components can continue importing individual exports,
// while the AI layer can consume this single object.
// ---------------------------------------------------------------------------
...
// AI/RAG METADATA
//
// Helps future retrieval code understand what this module contains.
// ---------------------------------------------------------------------------

export const portfolioKnowledgeMetadata = {
...
export const projects: ProjectCaseStudy[] = [
  {
    key: "event-driven-order-platform",
    number: "01",
    ...
    description:
      "A distributed order-processing platform designed around asynchronous workflows and independently deployable services.",
